    ...
    <section class="container-fluid m-aboutMe" :style="{'height' : innerHeight + 'px'}">
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center text-center">
                <div class="col-md-12">
                    <h2 class="font-size-55 font-weight-bold thirdMainColor">{{title}}</h2>
                    <p class="font-size-30 firstMainColor">{{subTitle}}</p>
                </div>
            </div>
        </div>
        <div class="elementor-shape elementor-shape-bottom" data-shape="wave-brush" data-negative="false">
